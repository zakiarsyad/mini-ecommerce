<template>
    <div>
        ...
        <div id="detail" class="shadow bg-white fixed z-20 rounded">
            <div class="w-10/12 mx-auto my-6 h-full">
                <div class="flex justify-center relative">
                    <h1 class="h-6 text-5xl font-bold mb-6">ADD NEW PRODUCT</h1>
                    <button
                        ...
                        <div class="w-full px-3">
                            ...
                            <div class="relative">
                                <select 
                                    ...
                                    <option>-</option>
                                    <option>Shortboards</option>
                                    <option>Mid Lengths</option>
                                    <option>Longboards</option>
                                </select>
...
export default {
    ...
    methods: {
        ...
        handleimage() {
            ...
            this.newProduct.image = this.$refs.image.files[0]
        },
        addNewProduct() {
            ...
            this.$emit('addNewProduct', formData)
        },
